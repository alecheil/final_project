# hopefull this will be the final revision page
# copy this and clean it up for final file

# refer to test_01-03
# use format from test_02
# use test_02 to add things/test them before putting them in this one
## add all of the fluffy stuff to make it look better
### look at game_01 for story line and fluffy stuff
# add error handling
# also look into using random to add a chance to the hill outcomes
## refer to notes in game_01 about ideas for random chance
